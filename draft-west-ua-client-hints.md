...
~~~ example
  User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko)
              Chrome/68.0.2704.79 Safari/537.36 Edge/18.014
~~~
...
Client Hints ({{I-D.ietf-httpd-client-hints}}) that can provide the client's branding and version
...
in {{I-D.ietf-httpd-client-hints}}. The definitions below assume that each user agent has defined
...
## The 'Sec-CH-Platform' Header Field
